...
//    private ArrayList<String[]> lines = new ArrayList<String[]>();
     ...
     * Sorry about the compression here, trying to save space
     * Just is a HashMap of 0-F to its numerical number
     */
    ...
    public void inputConvertPrintWrite() {
        try {
            ...
            Scanner scanner = new Scanner(new File("datafiles/values30.dat")); //lol change to your
